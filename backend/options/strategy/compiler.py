...
RuleSource = Literal["backend_default", "backend_required", "user_input"]
        ...
        if lower_value is not None:
            rules.append(
                NormalizedRule(
                    ...
                    required=True,
                    source=_normalize_rule_source(inputs["index_lower_boundary"].source),
                )
            )
        if upper_value is not None:
            rules.append(
                NormalizedRule(
                    ...
                    required=True,
                    source=_normalize_rule_source(inputs["index_upper_boundary"].source),
                )
            )
        if mtm_stop_value is not None:
            rules.append(
                NormalizedRule(
                    ...
                    source=_normalize_rule_source(inputs["basket_mtm_stoploss"].source),
                )
            )
        if mtm_target_value is not None:
            rules.append(
                NormalizedRule(
                    ...
                    source=_normalize_rule_source(inputs["basket_mtm_target"].source),
                )
            )
...
def _normalize_rule_source(source: str) -> RuleSource:
    if source in {"backend_default", "backend_required", "user_input"}:
        return cast(RuleSource, source)
