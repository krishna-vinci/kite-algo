...
from backend.api.services.runtime_recovery import build_worker_runtime_recovery_service
from backend.broker_api.orders import bracket_runtime_store, get_bracket_executor_wakeup_event, run_bracket_executor_once
from backend.app.monitor import heartbeat, set_component_status
...
async def _bracket_executor_loop(app: FastAPI):
    ...
    async def _place_order_fn(*, strategy_run_id: str, account_id: str, bracket_intent_id: str, action_type: str, payload: Dict[str, Any], idempotency_key: str):
        from backend.broker_api.orders import OrdersService, PlaceOrderRequest
