...
from backend.api.repositories.algo_worker_repo import (
...
async def combined_lifespan(app: FastAPI):
    ...
    try:
        ...
        try:
            from backend.algo_runtime.live import AlgoRuntimeLiveWorker
            from backend.algo_runtime.kernel import AlgoKernel
            from backend.algo_runtime.intent_bridge import IntentBridge, KiteOrdersIntentHandler
            from backend.algo_runtime.indicators import BuiltInIndicatorReader
            from backend.algo_runtime.registry import AlgoRegistry
            from backend.algo_runtime.repository import SqlAlchemyAlgoRepository
            from backend.algo_runtime.service import AlgoRuntimeService
            from backend.algo_runtime.snapshot_builder import (
            ...
            from backend.algo_runtime.state_store import InMemoryAlgoStateStore
            ...
            from backend.paper_runtime import DryRunIntentHandler, PaperIntentHandler, PaperMarketEngine, PaperTradingService
