...
from backend.api.config.openapi import OPENAPI_TAGS
from backend.app.bootstrap import combined_lifespan
from backend.app.middleware import setup_middleware

from backend.api.routers import ALL_ROUTERS
from backend.broker_api.market.candles_api import router as candles_api_router
from backend.broker_api.core.historical_routes import router as broker_historical_routes_router
from backend.broker_api.instruments.routes import router as broker_instruments_router
from backend.broker_api.mutual_funds.kite_mutual_funds import router as kite_mutual_funds_router
from backend.broker_api.performance.performance_router import router as performance_router
...
from backend.app.monitor import install_log_buffer
