...
async def load_live_run_flatness(request: Any, run: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not remaining_legs and broker_positions:
        from backend.api.routers.worker_shared import _load_live_kite_for_account, _live_broker_positions_for_attribution, _refresh_live_account_state, _worker_run_live_attribution_refs
