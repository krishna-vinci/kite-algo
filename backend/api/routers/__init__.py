...
from backend.api.routers.worker_proposals import router as worker_proposals_router
...
from backend.api.routers.journal import router as journal_router
from backend.api.routers.market_data import router as market_data_router
from backend.api.routers.marketwatch import router as marketwatch_router
from backend.api.routers.user_settings import router as user_settings_router

# Also import broker_api and strategy routers
from backend.broker_api.orders.routes import router as orders_router
from backend.broker_api.core.routes import router as broker_core_router
