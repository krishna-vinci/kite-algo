...
async def perform_login():
    ...
    if validate_authcode_result[0] != SUCCESS:
        return validate_authcode_result

    return {"status": "success", "access_token": validate_authcode_result[1]}


# <div class="grid grid-cols-2 border border-gray-200 divide-y divide-gray-200 divide-x">
#   <template x-for="([sym, ret], i) in momentumStocks" :key="sym">
#     <div class="p-2 flex justify-between items-center">
#       <span class="text-sm font-medium" x-text="sym"></span>
#       <span
#         class="text-sm font-semibold"
#         :class="ret >= 0 ? 'text-green-500' : 'text-red-500'"
#         x-text="ret.toFixed(1) + '%'"
#       ></span>
#     </div>
#   </template>
# </div>