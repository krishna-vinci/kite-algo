...
> The `development` branch is prepared for the `0.7.4` worker SDK PyPI release. Publish/tag `kite-algo-worker-v0.7.4` before treating the pinned install as globally available.
