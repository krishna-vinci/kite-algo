...
<section class="max-w-6xl mx-auto p-4 space-y-6">
  <header class="flex items-center justify-between">
    ...
    <div class="flex gap-2">
      ...
      <button class="btn btn-secondary flex items-center gap-2" on:click={() => loadAlerts(true)} disabled={loading}>
          ...
          <div class="card flex flex-col justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600">
                ...
                <br />
                is {getOperatorLabel(a.operator)} {a.rhs_constant}
              </p>
            ...
            <div class="mt-4 flex justify-end">
              <button class="btn btn-danger flex items-center gap-1" on:click={() => deleteAlert(a.uuid)}>
