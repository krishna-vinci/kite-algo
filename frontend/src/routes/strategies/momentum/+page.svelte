<script lang="ts">
    ...
    async function executeOrders() {
        ...
        if (useBasket) {
            ...
            orderExecutionError = "Single order placement is not supported for this strategy. Please use basket orders.";
            isExecutingOrders = false;
            return;
        }
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="md:col-span-1">
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    ...
                    <div class="mb-4">
                        <p class="text-sm text-gray-600">Total Investable Margin: ₹{investableMargin.toFixed(2)}</p>
                        <p class="text-sm text-gray-600">Capital for Allocation: ₹{(investableMargin * (marginAllocationPercentage / 100)).toFixed(2)}</p>
                    </div>
                </div>
            ...
            <div class="md:col-span-2">
                <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                    ...
                    <MomentumStockTable
                        ...
                        bind:selectedStocks
                        calculatedShares={Object.fromEntries(calculatedAllocations.map(a => [a.symbol, a.quantity]))}
